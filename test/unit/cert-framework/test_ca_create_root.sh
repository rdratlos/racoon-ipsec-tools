...
assert_contains "$certtext" "CN = Nepomuc SecureNet Root CA" "root cert subject CN matches"
assert_contains "$certtext" "O = Nepomuc SecureNet" "root cert subject O matches"
